...
|RF-006|O usuário pode colocar o comentário em estoque a quantidade que ele tem de remedios e garantir que a quantidade tomada seja subtraída da quantidade em estoque. |BAIXA|
