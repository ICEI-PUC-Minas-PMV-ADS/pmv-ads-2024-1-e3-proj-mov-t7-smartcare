...
import { Searchbar, Card, IconButton, TouchableRipple } from 'react-native-paper';
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.introText}>
                <Text style={styles.introBold}>Bem-vindo ao Smartcare</Text> - a sua solução completa para o gerenciamento eficiente e inteligente de medicamentos, consultas e exames!
            </Text>
