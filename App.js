...
import AccountDetails from "./src/pages/AccountInfo";
...
function ExameStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="FormularioNovoExame"
        component={FormularioNovoExame}
      />
    </Stack.Navigator>
  );
}
...
function ConsultaStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="FormularioNovaReceita"
        component={FormularioNovaReceita}
      />
    </Stack.Navigator>
  );
}
...
function MedicamentoStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="FormularioNovoRemedio"
        component={FormularioNovoRemedio}
      />
    </Stack.Navigator>
  );
}
        ...
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          {isLoggedIn ? (
            ...
            <>
              ...
              <Stack.Screen name="AccountInfo" component={AccountDetails} />
